<template>
    <div v-if="sideBar" style="z-index: 99;"
        ...
        <ul class="flex flex-col cursor-pointer">
            ...
            <li>
                <a class="flex flex-row items-center h-12 text-black hover:bg-gray-100 rounded-lg" @click="this.$router.replace({ name: 'stocks' });">
                    <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-primary-dark">
